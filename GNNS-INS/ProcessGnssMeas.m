...
tRxNanos = gnssRaw.TimeNanos -gnssRaw.FullBiasNanos(1) - weekNumberNanos; %now from beginning of a week
...
tTxSeconds  = double(gnssRaw.ReceivedSvTimeNanos + gnssRaw.TimeOffsetNanos)*1e-9; %%%%%% added gnssRaw.TimeOffsetNanos

%check for week rollover in tRxSeconds

prSeconds  = tRxSeconds - tTxSeconds; %instead CheckGpsWeekRollover 
